// day 1: 12:00 we started landing page, contains navbar, desciption, pricing and testimonials
...
export default function LandingPage() {
  ...
  const testimonials = [
    {
      ...
      quote: "Sahayatri has transformed how I navigate the city. I can finally plan my routes with confidence.",
      color: "bg-orange-100",
      rating: 5
    },
    {
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex items-center justify-between">
            ...
            <Link href="/" className="flex items-center space-x-2 group">
              ...
              <span className="text-xl font-semibold text-gray-900 group-hover:text-orange-500 transition-colors duration-300">Sahayatri</span>
            </Link>
      ...
      <section ref={heroRef} id="hero" className="relative pt-36 pb-20 px-6 min-h-screen flex items-center">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-10 leading-relaxed animate-fade-in animate-delay-200">
            Sahayatri revolutionizes navigation for wheelchair users across Nepal. Find the most accessible routes, avoid obstacles, and travel with complete confidence.
          </p>
          ...
          <div className="mt-12 relative animate-scale-in">
            <div className="inline-block bg-gradient-to-r from-orange-500 to-amber-500 px-8 py-4 rounded-full shadow-xl shadow-orange-200/50 hover:shadow-2xl hover:shadow-orange-300/50 transition-all duration-500 hover:scale-105">
      ...
      <section ref={testimonialsRef} id="testimonials" className="py-20 bg-gradient-to-b from-white to-gray-50 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 animate-on-scroll">
            ...
            <p className="text-gray-600 text-lg">See what our users are saying about Sahayatri</p>
          </div>
      ...
      {/* CTA Section/ call to action ( will be directed to demo ) */}
      <section ref={ctaRef} id="cta" className="py-20 px-6 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-orange-500 to-amber-500 opacity-90 animate-gradient"></div>
      ...
      <footer className="bg-gray-900 text-white py-12 px-6 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 animate-on-scroll">
              <div className="flex items-center space-x-2 mb-4 group">
                ...
                <span className="text-lg font-semibold text-white group-hover:text-orange-400 transition-colors duration-300">Sahayatri</span>
              </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center animate-on-scroll">
            <p className="text-xs text-gray-500">© 2026 Sahayatri. All rights reserved.</p>
          </div>
        </div>
      </footer>
